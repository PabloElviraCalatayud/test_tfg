...
% Figura pendiente: diagrama de arquitectura de tres capas
% (dispositivo -> aplicación móvil -> MQTT/PostgreSQL/Grafana),
% pendiente de generar y subir por el autor/a.
% \begin{figure}[H]
%   \centering
%   \includegraphics[width=0.8\linewidth]{figuras/arquitectura_sistema.png}
%   \caption{Arquitectura general del sistema, en tres capas.}
%   \label{fig:arquitectura}
% \end{figure}
\textcolor{colorIA}{[Figura pendiente: diagrama de arquitectura de tres capas — dispositivo, aplicación móvil y plataforma en la nube. El bloque \texttt{figure} ya preparado arriba está comentado; al añadir la imagen a \texttt{figuras/}, basta con descomentarlo.]}
